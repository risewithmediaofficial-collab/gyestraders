...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      >
        <div className="relative aspect-square overflow-hidden bg-[#f5f0e8] p-4 flex items-center justify-center">
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <ViewButton onClick={() => setShowModal(true)}>
            <Eye size={14} />
            {product.variants && product.variants.length > 0 ? 'View Options' : 'View Details'}
          </ViewButton>
        </div>
      </motion.div>
